...
extern "C"
{
	...
	const char*			UnityIPhoneRuntimeVersion = "5.0.0f4";
...
#define DLL_EXPORT __declspec(dllexport)
	...
	DECL_USER_FUNC(Achievement_TotalSteps);
	DECL_USER_FUNC(Achievement_Description);
	DECL_USER_FUNC(Achievement_Dispose);
	DECL_USER_FUNC(Achievement_UnlockedIconUrl);
	DECL_USER_FUNC(Achievement_LastModifiedTime);
	DECL_USER_FUNC(Achievement_RevealedIconUrl);
	DECL_USER_FUNC(Achievement_CurrentSteps);
	DECL_USER_FUNC(Achievement_State);
	DECL_USER_FUNC(Achievement_Valid);
	DECL_USER_FUNC(Achievement_LastModified);
	DECL_USER_FUNC(Achievement_XP);
	DECL_USER_FUNC(Achievement_Type);
	DECL_USER_FUNC(Achievement_Id);
	DECL_USER_FUNC(Achievement_Name);
	DECL_USER_FUNC(AchievementManager_FetchAll);
	DECL_USER_FUNC(AchievementManager_Reveal);
	DECL_USER_FUNC(AchievementManager_Unlock);
	DECL_USER_FUNC(AchievementManager_ShowAllUI);
	DECL_USER_FUNC(AchievementManager_SetStepsAtLeast);
	DECL_USER_FUNC(AchievementManager_Increment);
	DECL_USER_FUNC(AchievementManager_Fetch);
	DECL_USER_FUNC(AchievementManager_FetchAllResponse_Dispose);
	DECL_USER_FUNC(AchievementManager_FetchAllResponse_GetStatus);
	DECL_USER_FUNC(AchievementManager_FetchAllResponse_GetData_Length);
	DECL_USER_FUNC(AchievementManager_FetchAllResponse_GetData_GetElement);
	DECL_USER_FUNC(AchievementManager_FetchResponse_Dispose);
	DECL_USER_FUNC(AchievementManager_FetchResponse_GetStatus);
	DECL_USER_FUNC(AchievementManager_FetchResponse_GetData);
	DECL_USER_FUNC(GameServices_Builder_SetOnAuthActionStarted);
	DECL_USER_FUNC(GameServices_Builder_AddOauthScope);
	DECL_USER_FUNC(GameServices_Builder_SetLogging);
	DECL_USER_FUNC(GameServices_Builder_Construct);
	DECL_USER_FUNC(GameServices_Builder_EnableSnapshots);
	DECL_USER_FUNC(GameServices_Builder_SetOnLog);
	DECL_USER_FUNC(GameServices_Builder_SetDefaultOnLog);
	DECL_USER_FUNC(GameServices_Builder_SetOnAuthActionFinished);
	DECL_USER_FUNC(GameServices_Builder_SetOnTurnBasedMatchEvent);
	DECL_USER_FUNC(GameServices_Builder_SetOnQuestCompleted);
	DECL_USER_FUNC(GameServices_Builder_SetOnMultiplayerInvitationEvent);
	DECL_USER_FUNC(GameServices_Builder_Create);
	DECL_USER_FUNC(GameServices_Builder_Dispose);
	DECL_USER_FUNC(GameServices_Flush);
	DECL_USER_FUNC(GameServices_IsAuthorized);
	DECL_USER_FUNC(GameServices_Dispose);
	DECL_USER_FUNC(GameServices_SignOut);
	DECL_USER_FUNC(GameServices_StartAuthorizationUI);
	DECL_USER_FUNC(InternalHooks_ConfigureForUnityPlugin);
	DECL_USER_FUNC(IosPlatformConfiguration_Construct);
	DECL_USER_FUNC(IosPlatformConfiguration_Dispose);
	DECL_USER_FUNC(IosPlatformConfiguration_Valid);
	DECL_USER_FUNC(IosPlatformConfiguration_SetClientID);
	DECL_USER_FUNC(Leaderboard_Name);
	DECL_USER_FUNC(Leaderboard_Id);
	DECL_USER_FUNC(Leaderboard_IconUrl);
	DECL_USER_FUNC(Leaderboard_Dispose);
	DECL_USER_FUNC(Leaderboard_Valid);
	DECL_USER_FUNC(Leaderboard_Order);
	DECL_USER_FUNC(LeaderboardManager_FetchAll);
	DECL_USER_FUNC(LeaderboardManager_FetchScoreSummary);
	DECL_USER_FUNC(LeaderboardManager_ScorePageToken);
	DECL_USER_FUNC(LeaderboardManager_ShowAllUI);
	DECL_USER_FUNC(LeaderboardManager_FetchScorePage);
	DECL_USER_FUNC(LeaderboardManager_FetchAllScoreSummaries);
	DECL_USER_FUNC(LeaderboardManager_ShowUI);
	DECL_USER_FUNC(LeaderboardManager_Fetch);
	DECL_USER_FUNC(LeaderboardManager_SubmitScore);
	DECL_USER_FUNC(LeaderboardManager_FetchResponse_Dispose);
	DECL_USER_FUNC(LeaderboardManager_FetchResponse_GetStatus);
	DECL_USER_FUNC(LeaderboardManager_FetchResponse_GetData);
	DECL_USER_FUNC(LeaderboardManager_FetchAllResponse_Dispose);
	DECL_USER_FUNC(LeaderboardManager_FetchAllResponse_GetStatus);
	DECL_USER_FUNC(LeaderboardManager_FetchAllResponse_GetData_Length);
	DECL_USER_FUNC(LeaderboardManager_FetchAllResponse_GetData_GetElement);
	DECL_USER_FUNC(LeaderboardManager_FetchScorePageResponse_Dispose);
	DECL_USER_FUNC(LeaderboardManager_FetchScorePageResponse_GetStatus);
	DECL_USER_FUNC(LeaderboardManager_FetchScorePageResponse_GetData);
	DECL_USER_FUNC(LeaderboardManager_FetchScoreSummaryResponse_Dispose);
	DECL_USER_FUNC(LeaderboardManager_FetchScoreSummaryResponse_GetStatus);
	DECL_USER_FUNC(LeaderboardManager_FetchScoreSummaryResponse_GetData);
	DECL_USER_FUNC(LeaderboardManager_FetchAllScoreSummariesResponse_Dispose);
	DECL_USER_FUNC(LeaderboardManager_FetchAllScoreSummariesResponse_GetStatus);
	DECL_USER_FUNC(LeaderboardManager_FetchAllScoreSummariesResponse_GetData_Length);
	DECL_USER_FUNC(LeaderboardManager_FetchAllScoreSummariesResponse_GetData_GetElement);
	DECL_USER_FUNC(MultiplayerInvitation_AutomatchingSlotsAvailable);
	DECL_USER_FUNC(MultiplayerInvitation_InvitingParticipant);
	DECL_USER_FUNC(MultiplayerInvitation_Variant);
	DECL_USER_FUNC(MultiplayerInvitation_CreationTime);
	DECL_USER_FUNC(MultiplayerInvitation_Participants_Length);
	DECL_USER_FUNC(MultiplayerInvitation_Participants_GetElement);
	DECL_USER_FUNC(MultiplayerInvitation_Valid);
	DECL_USER_FUNC(MultiplayerInvitation_Type);
	DECL_USER_FUNC(MultiplayerInvitation_Id);
	DECL_USER_FUNC(MultiplayerInvitation_Dispose);
	DECL_USER_FUNC(MultiplayerParticipant_Status);
	DECL_USER_FUNC(MultiplayerParticipant_MatchRank);
	DECL_USER_FUNC(MultiplayerParticipant_IsConnectedToRoom);
	DECL_USER_FUNC(MultiplayerParticipant_DisplayName);
	DECL_USER_FUNC(MultiplayerParticipant_HasPlayer);
	DECL_USER_FUNC(MultiplayerParticipant_AvatarUrl);
	DECL_USER_FUNC(MultiplayerParticipant_MatchResult);
	DECL_USER_FUNC(MultiplayerParticipant_Player);
	DECL_USER_FUNC(MultiplayerParticipant_Dispose);
	DECL_USER_FUNC(MultiplayerParticipant_Valid);
	DECL_USER_FUNC(MultiplayerParticipant_HasMatchResult);
	DECL_USER_FUNC(MultiplayerParticipant_Id);
	DECL_USER_FUNC(ParticipantResults_WithResult);
	DECL_USER_FUNC(ParticipantResults_Valid);
	DECL_USER_FUNC(ParticipantResults_MatchResultForParticipant);
	DECL_USER_FUNC(ParticipantResults_PlaceForParticipant);
	DECL_USER_FUNC(ParticipantResults_HasResultsForParticipant);
	DECL_USER_FUNC(ParticipantResults_Dispose);
	DECL_USER_FUNC(Player_CurrentLevel);
	DECL_USER_FUNC(Player_Name);
	DECL_USER_FUNC(Player_Dispose);
	DECL_USER_FUNC(Player_AvatarUrl);
	DECL_USER_FUNC(Player_LastLevelUpTime);
	DECL_USER_FUNC(Player_Title);
	DECL_USER_FUNC(Player_CurrentXP);
	DECL_USER_FUNC(Player_Valid);
	DECL_USER_FUNC(Player_HasLevelInfo);
	DECL_USER_FUNC(Player_NextLevel);
	DECL_USER_FUNC(Player_Id);
	DECL_USER_FUNC(PlayerManager_FetchInvitable);
	DECL_USER_FUNC(PlayerManager_FetchConnected);
	DECL_USER_FUNC(PlayerManager_Fetch);
	DECL_USER_FUNC(PlayerManager_FetchRecentlyPlayed);
	DECL_USER_FUNC(PlayerManager_FetchSelf);
	DECL_USER_FUNC(PlayerManager_FetchSelfResponse_Dispose);
	DECL_USER_FUNC(PlayerManager_FetchSelfResponse_GetStatus);
	DECL_USER_FUNC(PlayerManager_FetchSelfResponse_GetData);
	DECL_USER_FUNC(PlayerManager_FetchResponse_Dispose);
	DECL_USER_FUNC(PlayerManager_FetchResponse_GetStatus);
	DECL_USER_FUNC(PlayerManager_FetchResponse_GetData);
	DECL_USER_FUNC(PlayerManager_FetchListResponse_Dispose);
	DECL_USER_FUNC(PlayerManager_FetchListResponse_GetStatus);
	DECL_USER_FUNC(PlayerManager_FetchListResponse_GetData_Length);
	DECL_USER_FUNC(PlayerManager_FetchListResponse_GetData_GetElement);
	DECL_USER_FUNC(RealTimeEventListenerHelper_SetOnParticipantStatusChangedCallback);
	DECL_USER_FUNC(RealTimeEventListenerHelper_Construct);
	DECL_USER_FUNC(RealTimeEventListenerHelper_SetOnP2PDisconnectedCallback);
	DECL_USER_FUNC(RealTimeEventListenerHelper_SetOnDataReceivedCallback);
	DECL_USER_FUNC(RealTimeEventListenerHelper_SetOnRoomStatusChangedCallback);
	DECL_USER_FUNC(RealTimeEventListenerHelper_SetOnP2PConnectedCallback);
	DECL_USER_FUNC(RealTimeEventListenerHelper_SetOnRoomConnectedSetChangedCallback);
	DECL_USER_FUNC(RealTimeEventListenerHelper_Dispose);
	DECL_USER_FUNC(RealTimeMultiplayerManager_CreateRealTimeRoom);
	DECL_USER_FUNC(RealTimeMultiplayerManager_LeaveRoom);
	DECL_USER_FUNC(RealTimeMultiplayerManager_SendUnreliableMessage);
	DECL_USER_FUNC(RealTimeMultiplayerManager_ShowWaitingRoomUI);
	DECL_USER_FUNC(RealTimeMultiplayerManager_ShowPlayerSelectUI);
	DECL_USER_FUNC(RealTimeMultiplayerManager_DismissInvitation);
	DECL_USER_FUNC(RealTimeMultiplayerManager_DeclineInvitation);
	DECL_USER_FUNC(RealTimeMultiplayerManager_SendReliableMessage);
	DECL_USER_FUNC(RealTimeMultiplayerManager_AcceptInvitation);
	DECL_USER_FUNC(RealTimeMultiplayerManager_FetchInvitations);
	DECL_USER_FUNC(RealTimeMultiplayerManager_SendUnreliableMessageToOthers);
	DECL_USER_FUNC(RealTimeMultiplayerManager_ShowRoomInboxUI);
	DECL_USER_FUNC(RealTimeMultiplayerManager_RealTimeRoomResponse_Dispose);
	DECL_USER_FUNC(RealTimeMultiplayerManager_RealTimeRoomResponse_GetStatus);
	DECL_USER_FUNC(RealTimeMultiplayerManager_RealTimeRoomResponse_GetRoom);
	DECL_USER_FUNC(RealTimeMultiplayerManager_RoomInboxUIResponse_Dispose);
	DECL_USER_FUNC(RealTimeMultiplayerManager_RoomInboxUIResponse_GetStatus);
	DECL_USER_FUNC(RealTimeMultiplayerManager_RoomInboxUIResponse_GetInvitation);
	DECL_USER_FUNC(RealTimeMultiplayerManager_WaitingRoomUIResponse_Dispose);
	DECL_USER_FUNC(RealTimeMultiplayerManager_WaitingRoomUIResponse_GetStatus);
	DECL_USER_FUNC(RealTimeMultiplayerManager_WaitingRoomUIResponse_GetRoom);
	DECL_USER_FUNC(RealTimeMultiplayerManager_FetchInvitationsResponse_Dispose);
	DECL_USER_FUNC(RealTimeMultiplayerManager_FetchInvitationsResponse_GetStatus);
	DECL_USER_FUNC(RealTimeMultiplayerManager_FetchInvitationsResponse_GetInvitations_Length);
	DECL_USER_FUNC(RealTimeMultiplayerManager_FetchInvitationsResponse_GetInvitations_GetElement);
	DECL_USER_FUNC(RealTimeRoom_Status);
	DECL_USER_FUNC(RealTimeRoom_Description);
	DECL_USER_FUNC(RealTimeRoom_Variant);
	DECL_USER_FUNC(RealTimeRoom_CreationTime);
	DECL_USER_FUNC(RealTimeRoom_Participants_Length);
	DECL_USER_FUNC(RealTimeRoom_Participants_GetElement);
	DECL_USER_FUNC(RealTimeRoom_Valid);
	DECL_USER_FUNC(RealTimeRoom_RemainingAutomatchingSlots);
	DECL_USER_FUNC(RealTimeRoom_AutomatchWaitEstimate);
	DECL_USER_FUNC(RealTimeRoom_CreatingParticipant);
	DECL_USER_FUNC(RealTimeRoom_Id);
	DECL_USER_FUNC(RealTimeRoom_Dispose);
	DECL_USER_FUNC(RealTimeRoomConfig_PlayerIdsToInvite_Length);
	DECL_USER_FUNC(RealTimeRoomConfig_PlayerIdsToInvite_GetElement);
	DECL_USER_FUNC(RealTimeRoomConfig_Variant);
	DECL_USER_FUNC(RealTimeRoomConfig_ExclusiveBitMask);
	DECL_USER_FUNC(RealTimeRoomConfig_Valid);
	DECL_USER_FUNC(RealTimeRoomConfig_MaximumAutomatchingPlayers);
	DECL_USER_FUNC(RealTimeRoomConfig_MinimumAutomatchingPlayers);
	DECL_USER_FUNC(RealTimeRoomConfig_Dispose);
	DECL_USER_FUNC(RealTimeRoomConfig_Builder_PopulateFromPlayerSelectUIResponse);
	DECL_USER_FUNC(RealTimeRoomConfig_Builder_SetVariant);
	DECL_USER_FUNC(RealTimeRoomConfig_Builder_AddPlayerToInvite);
	DECL_USER_FUNC(RealTimeRoomConfig_Builder_Construct);
	DECL_USER_FUNC(RealTimeRoomConfig_Builder_SetExclusiveBitMask);
	DECL_USER_FUNC(RealTimeRoomConfig_Builder_SetMaximumAutomatchingPlayers);
	DECL_USER_FUNC(RealTimeRoomConfig_Builder_Create);
	DECL_USER_FUNC(RealTimeRoomConfig_Builder_SetMinimumAutomatchingPlayers);
	DECL_USER_FUNC(RealTimeRoomConfig_Builder_Dispose);
	DECL_USER_FUNC(Score_Value);
	DECL_USER_FUNC(Score_Valid);
	DECL_USER_FUNC(Score_Rank);
	DECL_USER_FUNC(Score_Dispose);
	DECL_USER_FUNC(Score_Metadata);
	DECL_USER_FUNC(ScorePage_Dispose);
	DECL_USER_FUNC(ScorePage_TimeSpan);
	DECL_USER_FUNC(ScorePage_LeaderboardId);
	DECL_USER_FUNC(ScorePage_Collection);
	DECL_USER_FUNC(ScorePage_Start);
	DECL_USER_FUNC(ScorePage_Valid);
	DECL_USER_FUNC(ScorePage_HasPreviousScorePage);
	DECL_USER_FUNC(ScorePage_HasNextScorePage);
	DECL_USER_FUNC(ScorePage_PreviousScorePageToken);
	DECL_USER_FUNC(ScorePage_NextScorePageToken);
	DECL_USER_FUNC(ScorePage_Entries_Length);
	DECL_USER_FUNC(ScorePage_Entries_GetElement);
	DECL_USER_FUNC(ScorePage_Entry_Dispose);
	DECL_USER_FUNC(ScorePage_Entry_PlayerId);
	DECL_USER_FUNC(ScorePage_Entry_LastModified);
	DECL_USER_FUNC(ScorePage_Entry_Score);
	DECL_USER_FUNC(ScorePage_Entry_Valid);
	DECL_USER_FUNC(ScorePage_Entry_LastModifiedTime);
	DECL_USER_FUNC(ScorePage_ScorePageToken_Valid);
	DECL_USER_FUNC(ScorePage_ScorePageToken_Dispose);
	DECL_USER_FUNC(ScoreSummary_ApproximateNumberOfScores);
	DECL_USER_FUNC(ScoreSummary_TimeSpan);
	DECL_USER_FUNC(ScoreSummary_LeaderboardId);
	DECL_USER_FUNC(ScoreSummary_Collection);
	DECL_USER_FUNC(ScoreSummary_Valid);
	DECL_USER_FUNC(ScoreSummary_CurrentPlayerScore);
	DECL_USER_FUNC(ScoreSummary_Dispose);
	DECL_USER_FUNC(Sentinels_AutomatchingParticipant);
	DECL_USER_FUNC(SnapshotManager_FetchAll);
	DECL_USER_FUNC(SnapshotManager_ShowSelectUIOperation);
	DECL_USER_FUNC(SnapshotManager_Read);
	DECL_USER_FUNC(SnapshotManager_Commit);
	DECL_USER_FUNC(SnapshotManager_Open);
	DECL_USER_FUNC(SnapshotManager_ResolveConflict);
	DECL_USER_FUNC(SnapshotManager_Delete);
	DECL_USER_FUNC(SnapshotManager_FetchAllResponse_Dispose);
	DECL_USER_FUNC(SnapshotManager_FetchAllResponse_GetStatus);
	DECL_USER_FUNC(SnapshotManager_FetchAllResponse_GetData_Length);
	DECL_USER_FUNC(SnapshotManager_FetchAllResponse_GetData_GetElement);
	DECL_USER_FUNC(SnapshotManager_OpenResponse_Dispose);
	DECL_USER_FUNC(SnapshotManager_OpenResponse_GetStatus);
	DECL_USER_FUNC(SnapshotManager_OpenResponse_GetData);
	DECL_USER_FUNC(SnapshotManager_OpenResponse_GetConflictId);
	DECL_USER_FUNC(SnapshotManager_OpenResponse_GetConflictOriginal);
	DECL_USER_FUNC(SnapshotManager_OpenResponse_GetConflictUnmerged);
	DECL_USER_FUNC(SnapshotManager_CommitResponse_Dispose);
	DECL_USER_FUNC(SnapshotManager_CommitResponse_GetStatus);
	DECL_USER_FUNC(SnapshotManager_CommitResponse_GetData);
	DECL_USER_FUNC(SnapshotManager_ReadResponse_Dispose);
	DECL_USER_FUNC(SnapshotManager_ReadResponse_GetStatus);
	DECL_USER_FUNC(SnapshotManager_ReadResponse_GetData);
	DECL_USER_FUNC(SnapshotManager_SnapshotSelectUIResponse_Dispose);
	DECL_USER_FUNC(SnapshotManager_SnapshotSelectUIResponse_GetStatus);
	DECL_USER_FUNC(SnapshotManager_SnapshotSelectUIResponse_GetData);
	DECL_USER_FUNC(SnapshotMetadata_Dispose);
	DECL_USER_FUNC(SnapshotMetadata_CoverImageURL);
	DECL_USER_FUNC(SnapshotMetadata_Description);
	DECL_USER_FUNC(SnapshotMetadata_IsOpen);
	DECL_USER_FUNC(SnapshotMetadata_FileName);
	DECL_USER_FUNC(SnapshotMetadata_Valid);
	DECL_USER_FUNC(SnapshotMetadata_PlayedTime);
	DECL_USER_FUNC(SnapshotMetadata_LastModifiedTime);
	DECL_USER_FUNC(SnapshotMetadataChange_Description);
	DECL_USER_FUNC(SnapshotMetadataChange_Image);
	DECL_USER_FUNC(SnapshotMetadataChange_PlayedTimeIsChanged);
	DECL_USER_FUNC(SnapshotMetadataChange_Valid);
	DECL_USER_FUNC(SnapshotMetadataChange_PlayedTime);
	DECL_USER_FUNC(SnapshotMetadataChange_Dispose);
	DECL_USER_FUNC(SnapshotMetadataChange_ImageIsChanged);
	DECL_USER_FUNC(SnapshotMetadataChange_DescriptionIsChanged);
	DECL_USER_FUNC(SnapshotMetadataChange_Builder_SetDescription);
	DECL_USER_FUNC(SnapshotMetadataChange_Builder_Construct);
	DECL_USER_FUNC(SnapshotMetadataChange_Builder_SetPlayedTime);
	DECL_USER_FUNC(SnapshotMetadataChange_Builder_SetCoverImageFromPngData);
	DECL_USER_FUNC(SnapshotMetadataChange_Builder_Create);
	DECL_USER_FUNC(SnapshotMetadataChange_Builder_Dispose);
	DECL_USER_FUNC(TurnBasedMatch_AutomatchingSlotsAvailable);
	DECL_USER_FUNC(TurnBasedMatch_CreationTime);
	DECL_USER_FUNC(TurnBasedMatch_Participants_Length);
	DECL_USER_FUNC(TurnBasedMatch_Participants_GetElement);
	DECL_USER_FUNC(TurnBasedMatch_Version);
	DECL_USER_FUNC(TurnBasedMatch_ParticipantResults);
	DECL_USER_FUNC(TurnBasedMatch_Status);
	DECL_USER_FUNC(TurnBasedMatch_Description);
	DECL_USER_FUNC(TurnBasedMatch_PendingParticipant);
	DECL_USER_FUNC(TurnBasedMatch_Variant);
	DECL_USER_FUNC(TurnBasedMatch_HasPreviousMatchData);
	DECL_USER_FUNC(TurnBasedMatch_Data);
	DECL_USER_FUNC(TurnBasedMatch_LastUpdatingParticipant);
	DECL_USER_FUNC(TurnBasedMatch_HasData);
	DECL_USER_FUNC(TurnBasedMatch_SuggestedNextParticipant);
	DECL_USER_FUNC(TurnBasedMatch_PreviousMatchData);
	DECL_USER_FUNC(TurnBasedMatch_LastUpdateTime);
	DECL_USER_FUNC(TurnBasedMatch_RematchId);
	DECL_USER_FUNC(TurnBasedMatch_Number);
	DECL_USER_FUNC(TurnBasedMatch_HasRematchId);
	DECL_USER_FUNC(TurnBasedMatch_Valid);
	DECL_USER_FUNC(TurnBasedMatch_CreatingParticipant);
	DECL_USER_FUNC(TurnBasedMatch_Id);
	DECL_USER_FUNC(TurnBasedMatch_Dispose);
	DECL_USER_FUNC(TurnBasedMatchConfig_PlayerIdsToInvite_Length);
	DECL_USER_FUNC(TurnBasedMatchConfig_PlayerIdsToInvite_GetElement);
	DECL_USER_FUNC(TurnBasedMatchConfig_Variant);
	DECL_USER_FUNC(TurnBasedMatchConfig_ExclusiveBitMask);
	DECL_USER_FUNC(TurnBasedMatchConfig_Valid);
	DECL_USER_FUNC(TurnBasedMatchConfig_MaximumAutomatchingPlayers);
	DECL_USER_FUNC(TurnBasedMatchConfig_MinimumAutomatchingPlayers);
	DECL_USER_FUNC(TurnBasedMatchConfig_Dispose);
	DECL_USER_FUNC(TurnBasedMatchConfig_Builder_PopulateFromPlayerSelectUIResponse);
	DECL_USER_FUNC(TurnBasedMatchConfig_Builder_SetVariant);
	DECL_USER_FUNC(TurnBasedMatchConfig_Builder_AddPlayerToInvite);
	DECL_USER_FUNC(TurnBasedMatchConfig_Builder_Construct);
	DECL_USER_FUNC(TurnBasedMatchConfig_Builder_SetExclusiveBitMask);
	DECL_USER_FUNC(TurnBasedMatchConfig_Builder_SetMaximumAutomatchingPlayers);
	DECL_USER_FUNC(TurnBasedMatchConfig_Builder_Create);
	DECL_USER_FUNC(TurnBasedMatchConfig_Builder_SetMinimumAutomatchingPlayers);
	DECL_USER_FUNC(TurnBasedMatchConfig_Builder_Dispose);
	DECL_USER_FUNC(TurnBasedMultiplayerManager_ShowPlayerSelectUI);
	DECL_USER_FUNC(TurnBasedMultiplayerManager_CancelMatch);
	DECL_USER_FUNC(TurnBasedMultiplayerManager_DismissMatch);
	DECL_USER_FUNC(TurnBasedMultiplayerManager_ShowMatchInboxUI);
	DECL_USER_FUNC(TurnBasedMultiplayerManager_SynchronizeData);
	DECL_USER_FUNC(TurnBasedMultiplayerManager_Rematch);
	DECL_USER_FUNC(TurnBasedMultiplayerManager_DismissInvitation);
	DECL_USER_FUNC(TurnBasedMultiplayerManager_FetchMatch);
	DECL_USER_FUNC(TurnBasedMultiplayerManager_DeclineInvitation);
	DECL_USER_FUNC(TurnBasedMultiplayerManager_FinishMatchDuringMyTurn);
	DECL_USER_FUNC(TurnBasedMultiplayerManager_FetchMatches);
	DECL_USER_FUNC(TurnBasedMultiplayerManager_CreateTurnBasedMatch);
	DECL_USER_FUNC(TurnBasedMultiplayerManager_AcceptInvitation);
	DECL_USER_FUNC(TurnBasedMultiplayerManager_TakeMyTurn);
	DECL_USER_FUNC(TurnBasedMultiplayerManager_ConfirmPendingCompletion);
	DECL_USER_FUNC(TurnBasedMultiplayerManager_LeaveMatchDuringMyTurn);
	DECL_USER_FUNC(TurnBasedMultiplayerManager_LeaveMatchDuringTheirTurn);
	DECL_USER_FUNC(TurnBasedMultiplayerManager_TurnBasedMatchResponse_Dispose);
	DECL_USER_FUNC(TurnBasedMultiplayerManager_TurnBasedMatchResponse_GetStatus);
	DECL_USER_FUNC(TurnBasedMultiplayerManager_TurnBasedMatchResponse_GetMatch);
	DECL_USER_FUNC(TurnBasedMultiplayerManager_TurnBasedMatchesResponse_Dispose);
	DECL_USER_FUNC(TurnBasedMultiplayerManager_TurnBasedMatchesResponse_GetStatus);
	DECL_USER_FUNC(TurnBasedMultiplayerManager_TurnBasedMatchesResponse_GetInvitations_Length);
	DECL_USER_FUNC(TurnBasedMultiplayerManager_TurnBasedMatchesResponse_GetInvitations_GetElement);
	DECL_USER_FUNC(TurnBasedMultiplayerManager_TurnBasedMatchesResponse_GetMyTurnMatches_Length);
	DECL_USER_FUNC(TurnBasedMultiplayerManager_TurnBasedMatchesResponse_GetMyTurnMatches_GetElement);
	DECL_USER_FUNC(TurnBasedMultiplayerManager_TurnBasedMatchesResponse_GetTheirTurnMatches_Length);
	DECL_USER_FUNC(TurnBasedMultiplayerManager_TurnBasedMatchesResponse_GetTheirTurnMatches_GetElement);
	DECL_USER_FUNC(TurnBasedMultiplayerManager_TurnBasedMatchesResponse_GetCompletedMatches_Length);
	DECL_USER_FUNC(TurnBasedMultiplayerManager_TurnBasedMatchesResponse_GetCompletedMatches_GetElement);
	DECL_USER_FUNC(TurnBasedMultiplayerManager_MatchInboxUIResponse_Dispose);
	DECL_USER_FUNC(TurnBasedMultiplayerManager_MatchInboxUIResponse_GetStatus);
	DECL_USER_FUNC(TurnBasedMultiplayerManager_MatchInboxUIResponse_GetMatch);
	DECL_USER_FUNC(TurnBasedMultiplayerManager_PlayerSelectUIResponse_Dispose);
	DECL_USER_FUNC(TurnBasedMultiplayerManager_PlayerSelectUIResponse_GetStatus);
	DECL_USER_FUNC(TurnBasedMultiplayerManager_PlayerSelectUIResponse_GetPlayerIds_Length);
	DECL_USER_FUNC(TurnBasedMultiplayerManager_PlayerSelectUIResponse_GetPlayerIds_GetElement);
	DECL_USER_FUNC(TurnBasedMultiplayerManager_PlayerSelectUIResponse_GetMinimumAutomatchingPlayers);
	DECL_USER_FUNC(TurnBasedMultiplayerManager_PlayerSelectUIResponse_GetMaximumAutomatchingPlayers);
}
DLL_EXPORT void RegisterMonoModules()
{
	...
	REGISTER_USER_FUNC(Achievement_TotalSteps);
	REGISTER_USER_FUNC(Achievement_Description);
	REGISTER_USER_FUNC(Achievement_Dispose);
	REGISTER_USER_FUNC(Achievement_UnlockedIconUrl);
	REGISTER_USER_FUNC(Achievement_LastModifiedTime);
	REGISTER_USER_FUNC(Achievement_RevealedIconUrl);
	REGISTER_USER_FUNC(Achievement_CurrentSteps);
	REGISTER_USER_FUNC(Achievement_State);
	REGISTER_USER_FUNC(Achievement_Valid);
	REGISTER_USER_FUNC(Achievement_LastModified);
	REGISTER_USER_FUNC(Achievement_XP);
	REGISTER_USER_FUNC(Achievement_Type);
	REGISTER_USER_FUNC(Achievement_Id);
	REGISTER_USER_FUNC(Achievement_Name);
	REGISTER_USER_FUNC(AchievementManager_FetchAll);
	REGISTER_USER_FUNC(AchievementManager_Reveal);
	REGISTER_USER_FUNC(AchievementManager_Unlock);
	REGISTER_USER_FUNC(AchievementManager_ShowAllUI);
	REGISTER_USER_FUNC(AchievementManager_SetStepsAtLeast);
	REGISTER_USER_FUNC(AchievementManager_Increment);
	REGISTER_USER_FUNC(AchievementManager_Fetch);
	REGISTER_USER_FUNC(AchievementManager_FetchAllResponse_Dispose);
	REGISTER_USER_FUNC(AchievementManager_FetchAllResponse_GetStatus);
	REGISTER_USER_FUNC(AchievementManager_FetchAllResponse_GetData_Length);
	REGISTER_USER_FUNC(AchievementManager_FetchAllResponse_GetData_GetElement);
	REGISTER_USER_FUNC(AchievementManager_FetchResponse_Dispose);
	REGISTER_USER_FUNC(AchievementManager_FetchResponse_GetStatus);
	REGISTER_USER_FUNC(AchievementManager_FetchResponse_GetData);
	REGISTER_USER_FUNC(GameServices_Builder_SetOnAuthActionStarted);
	REGISTER_USER_FUNC(GameServices_Builder_AddOauthScope);
	REGISTER_USER_FUNC(GameServices_Builder_SetLogging);
	REGISTER_USER_FUNC(GameServices_Builder_Construct);
	REGISTER_USER_FUNC(GameServices_Builder_EnableSnapshots);
	REGISTER_USER_FUNC(GameServices_Builder_SetOnLog);
	REGISTER_USER_FUNC(GameServices_Builder_SetDefaultOnLog);
	REGISTER_USER_FUNC(GameServices_Builder_SetOnAuthActionFinished);
	REGISTER_USER_FUNC(GameServices_Builder_SetOnTurnBasedMatchEvent);
	REGISTER_USER_FUNC(GameServices_Builder_SetOnQuestCompleted);
	REGISTER_USER_FUNC(GameServices_Builder_SetOnMultiplayerInvitationEvent);
	REGISTER_USER_FUNC(GameServices_Builder_Create);
	REGISTER_USER_FUNC(GameServices_Builder_Dispose);
	REGISTER_USER_FUNC(GameServices_Flush);
	REGISTER_USER_FUNC(GameServices_IsAuthorized);
	REGISTER_USER_FUNC(GameServices_Dispose);
	REGISTER_USER_FUNC(GameServices_SignOut);
	REGISTER_USER_FUNC(GameServices_StartAuthorizationUI);
	REGISTER_USER_FUNC(InternalHooks_ConfigureForUnityPlugin);
	REGISTER_USER_FUNC(IosPlatformConfiguration_Construct);
	REGISTER_USER_FUNC(IosPlatformConfiguration_Dispose);
	REGISTER_USER_FUNC(IosPlatformConfiguration_Valid);
	REGISTER_USER_FUNC(IosPlatformConfiguration_SetClientID);
	REGISTER_USER_FUNC(Leaderboard_Name);
	REGISTER_USER_FUNC(Leaderboard_Id);
	REGISTER_USER_FUNC(Leaderboard_IconUrl);
	REGISTER_USER_FUNC(Leaderboard_Dispose);
	REGISTER_USER_FUNC(Leaderboard_Valid);
	REGISTER_USER_FUNC(Leaderboard_Order);
	REGISTER_USER_FUNC(LeaderboardManager_FetchAll);
	REGISTER_USER_FUNC(LeaderboardManager_FetchScoreSummary);
	REGISTER_USER_FUNC(LeaderboardManager_ScorePageToken);
	REGISTER_USER_FUNC(LeaderboardManager_ShowAllUI);
	REGISTER_USER_FUNC(LeaderboardManager_FetchScorePage);
	REGISTER_USER_FUNC(LeaderboardManager_FetchAllScoreSummaries);
	REGISTER_USER_FUNC(LeaderboardManager_ShowUI);
	REGISTER_USER_FUNC(LeaderboardManager_Fetch);
	REGISTER_USER_FUNC(LeaderboardManager_SubmitScore);
	REGISTER_USER_FUNC(LeaderboardManager_FetchResponse_Dispose);
	REGISTER_USER_FUNC(LeaderboardManager_FetchResponse_GetStatus);
	REGISTER_USER_FUNC(LeaderboardManager_FetchResponse_GetData);
	REGISTER_USER_FUNC(LeaderboardManager_FetchAllResponse_Dispose);
	REGISTER_USER_FUNC(LeaderboardManager_FetchAllResponse_GetStatus);
	REGISTER_USER_FUNC(LeaderboardManager_FetchAllResponse_GetData_Length);
	REGISTER_USER_FUNC(LeaderboardManager_FetchAllResponse_GetData_GetElement);
	REGISTER_USER_FUNC(LeaderboardManager_FetchScorePageResponse_Dispose);
	REGISTER_USER_FUNC(LeaderboardManager_FetchScorePageResponse_GetStatus);
	REGISTER_USER_FUNC(LeaderboardManager_FetchScorePageResponse_GetData);
	REGISTER_USER_FUNC(LeaderboardManager_FetchScoreSummaryResponse_Dispose);
	REGISTER_USER_FUNC(LeaderboardManager_FetchScoreSummaryResponse_GetStatus);
	REGISTER_USER_FUNC(LeaderboardManager_FetchScoreSummaryResponse_GetData);
	REGISTER_USER_FUNC(LeaderboardManager_FetchAllScoreSummariesResponse_Dispose);
	REGISTER_USER_FUNC(LeaderboardManager_FetchAllScoreSummariesResponse_GetStatus);
	REGISTER_USER_FUNC(LeaderboardManager_FetchAllScoreSummariesResponse_GetData_Length);
	REGISTER_USER_FUNC(LeaderboardManager_FetchAllScoreSummariesResponse_GetData_GetElement);
	REGISTER_USER_FUNC(MultiplayerInvitation_AutomatchingSlotsAvailable);
	REGISTER_USER_FUNC(MultiplayerInvitation_InvitingParticipant);
	REGISTER_USER_FUNC(MultiplayerInvitation_Variant);
	REGISTER_USER_FUNC(MultiplayerInvitation_CreationTime);
	REGISTER_USER_FUNC(MultiplayerInvitation_Participants_Length);
	REGISTER_USER_FUNC(MultiplayerInvitation_Participants_GetElement);
	REGISTER_USER_FUNC(MultiplayerInvitation_Valid);
	REGISTER_USER_FUNC(MultiplayerInvitation_Type);
	REGISTER_USER_FUNC(MultiplayerInvitation_Id);
	REGISTER_USER_FUNC(MultiplayerInvitation_Dispose);
	REGISTER_USER_FUNC(MultiplayerParticipant_Status);
	REGISTER_USER_FUNC(MultiplayerParticipant_MatchRank);
	REGISTER_USER_FUNC(MultiplayerParticipant_IsConnectedToRoom);
	REGISTER_USER_FUNC(MultiplayerParticipant_DisplayName);
	REGISTER_USER_FUNC(MultiplayerParticipant_HasPlayer);
	REGISTER_USER_FUNC(MultiplayerParticipant_AvatarUrl);
	REGISTER_USER_FUNC(MultiplayerParticipant_MatchResult);
	REGISTER_USER_FUNC(MultiplayerParticipant_Player);
	REGISTER_USER_FUNC(MultiplayerParticipant_Dispose);
	REGISTER_USER_FUNC(MultiplayerParticipant_Valid);
	REGISTER_USER_FUNC(MultiplayerParticipant_HasMatchResult);
	REGISTER_USER_FUNC(MultiplayerParticipant_Id);
	REGISTER_USER_FUNC(ParticipantResults_WithResult);
	REGISTER_USER_FUNC(ParticipantResults_Valid);
	REGISTER_USER_FUNC(ParticipantResults_MatchResultForParticipant);
	REGISTER_USER_FUNC(ParticipantResults_PlaceForParticipant);
	REGISTER_USER_FUNC(ParticipantResults_HasResultsForParticipant);
	REGISTER_USER_FUNC(ParticipantResults_Dispose);
	REGISTER_USER_FUNC(Player_CurrentLevel);
	REGISTER_USER_FUNC(Player_Name);
	REGISTER_USER_FUNC(Player_Dispose);
	REGISTER_USER_FUNC(Player_AvatarUrl);
	REGISTER_USER_FUNC(Player_LastLevelUpTime);
	REGISTER_USER_FUNC(Player_Title);
	REGISTER_USER_FUNC(Player_CurrentXP);
	REGISTER_USER_FUNC(Player_Valid);
	REGISTER_USER_FUNC(Player_HasLevelInfo);
	REGISTER_USER_FUNC(Player_NextLevel);
	REGISTER_USER_FUNC(Player_Id);
	REGISTER_USER_FUNC(PlayerManager_FetchInvitable);
	REGISTER_USER_FUNC(PlayerManager_FetchConnected);
	REGISTER_USER_FUNC(PlayerManager_Fetch);
	REGISTER_USER_FUNC(PlayerManager_FetchRecentlyPlayed);
	REGISTER_USER_FUNC(PlayerManager_FetchSelf);
	REGISTER_USER_FUNC(PlayerManager_FetchSelfResponse_Dispose);
	REGISTER_USER_FUNC(PlayerManager_FetchSelfResponse_GetStatus);
	REGISTER_USER_FUNC(PlayerManager_FetchSelfResponse_GetData);
	REGISTER_USER_FUNC(PlayerManager_FetchResponse_Dispose);
	REGISTER_USER_FUNC(PlayerManager_FetchResponse_GetStatus);
	REGISTER_USER_FUNC(PlayerManager_FetchResponse_GetData);
	REGISTER_USER_FUNC(PlayerManager_FetchListResponse_Dispose);
	REGISTER_USER_FUNC(PlayerManager_FetchListResponse_GetStatus);
	REGISTER_USER_FUNC(PlayerManager_FetchListResponse_GetData_Length);
	REGISTER_USER_FUNC(PlayerManager_FetchListResponse_GetData_GetElement);
	REGISTER_USER_FUNC(RealTimeEventListenerHelper_SetOnParticipantStatusChangedCallback);
	REGISTER_USER_FUNC(RealTimeEventListenerHelper_Construct);
	REGISTER_USER_FUNC(RealTimeEventListenerHelper_SetOnP2PDisconnectedCallback);
	REGISTER_USER_FUNC(RealTimeEventListenerHelper_SetOnDataReceivedCallback);
	REGISTER_USER_FUNC(RealTimeEventListenerHelper_SetOnRoomStatusChangedCallback);
	REGISTER_USER_FUNC(RealTimeEventListenerHelper_SetOnP2PConnectedCallback);
	REGISTER_USER_FUNC(RealTimeEventListenerHelper_SetOnRoomConnectedSetChangedCallback);
	REGISTER_USER_FUNC(RealTimeEventListenerHelper_Dispose);
	REGISTER_USER_FUNC(RealTimeMultiplayerManager_CreateRealTimeRoom);
	REGISTER_USER_FUNC(RealTimeMultiplayerManager_LeaveRoom);
	REGISTER_USER_FUNC(RealTimeMultiplayerManager_SendUnreliableMessage);
	REGISTER_USER_FUNC(RealTimeMultiplayerManager_ShowWaitingRoomUI);
	REGISTER_USER_FUNC(RealTimeMultiplayerManager_ShowPlayerSelectUI);
	REGISTER_USER_FUNC(RealTimeMultiplayerManager_DismissInvitation);
	REGISTER_USER_FUNC(RealTimeMultiplayerManager_DeclineInvitation);
	REGISTER_USER_FUNC(RealTimeMultiplayerManager_SendReliableMessage);
	REGISTER_USER_FUNC(RealTimeMultiplayerManager_AcceptInvitation);
	REGISTER_USER_FUNC(RealTimeMultiplayerManager_FetchInvitations);
	REGISTER_USER_FUNC(RealTimeMultiplayerManager_SendUnreliableMessageToOthers);
	REGISTER_USER_FUNC(RealTimeMultiplayerManager_ShowRoomInboxUI);
	REGISTER_USER_FUNC(RealTimeMultiplayerManager_RealTimeRoomResponse_Dispose);
	REGISTER_USER_FUNC(RealTimeMultiplayerManager_RealTimeRoomResponse_GetStatus);
	REGISTER_USER_FUNC(RealTimeMultiplayerManager_RealTimeRoomResponse_GetRoom);
	REGISTER_USER_FUNC(RealTimeMultiplayerManager_RoomInboxUIResponse_Dispose);
	REGISTER_USER_FUNC(RealTimeMultiplayerManager_RoomInboxUIResponse_GetStatus);
	REGISTER_USER_FUNC(RealTimeMultiplayerManager_RoomInboxUIResponse_GetInvitation);
	REGISTER_USER_FUNC(RealTimeMultiplayerManager_WaitingRoomUIResponse_Dispose);
	REGISTER_USER_FUNC(RealTimeMultiplayerManager_WaitingRoomUIResponse_GetStatus);
	REGISTER_USER_FUNC(RealTimeMultiplayerManager_WaitingRoomUIResponse_GetRoom);
	REGISTER_USER_FUNC(RealTimeMultiplayerManager_FetchInvitationsResponse_Dispose);
	REGISTER_USER_FUNC(RealTimeMultiplayerManager_FetchInvitationsResponse_GetStatus);
	REGISTER_USER_FUNC(RealTimeMultiplayerManager_FetchInvitationsResponse_GetInvitations_Length);
	REGISTER_USER_FUNC(RealTimeMultiplayerManager_FetchInvitationsResponse_GetInvitations_GetElement);
	REGISTER_USER_FUNC(RealTimeRoom_Status);
	REGISTER_USER_FUNC(RealTimeRoom_Description);
	REGISTER_USER_FUNC(RealTimeRoom_Variant);
	REGISTER_USER_FUNC(RealTimeRoom_CreationTime);
	REGISTER_USER_FUNC(RealTimeRoom_Participants_Length);
	REGISTER_USER_FUNC(RealTimeRoom_Participants_GetElement);
	REGISTER_USER_FUNC(RealTimeRoom_Valid);
	REGISTER_USER_FUNC(RealTimeRoom_RemainingAutomatchingSlots);
	REGISTER_USER_FUNC(RealTimeRoom_AutomatchWaitEstimate);
	REGISTER_USER_FUNC(RealTimeRoom_CreatingParticipant);
	REGISTER_USER_FUNC(RealTimeRoom_Id);
	REGISTER_USER_FUNC(RealTimeRoom_Dispose);
	REGISTER_USER_FUNC(RealTimeRoomConfig_PlayerIdsToInvite_Length);
	REGISTER_USER_FUNC(RealTimeRoomConfig_PlayerIdsToInvite_GetElement);
	REGISTER_USER_FUNC(RealTimeRoomConfig_Variant);
	REGISTER_USER_FUNC(RealTimeRoomConfig_ExclusiveBitMask);
	REGISTER_USER_FUNC(RealTimeRoomConfig_Valid);
	REGISTER_USER_FUNC(RealTimeRoomConfig_MaximumAutomatchingPlayers);
	REGISTER_USER_FUNC(RealTimeRoomConfig_MinimumAutomatchingPlayers);
	REGISTER_USER_FUNC(RealTimeRoomConfig_Dispose);
	REGISTER_USER_FUNC(RealTimeRoomConfig_Builder_PopulateFromPlayerSelectUIResponse);
	REGISTER_USER_FUNC(RealTimeRoomConfig_Builder_SetVariant);
	REGISTER_USER_FUNC(RealTimeRoomConfig_Builder_AddPlayerToInvite);
	REGISTER_USER_FUNC(RealTimeRoomConfig_Builder_Construct);
	REGISTER_USER_FUNC(RealTimeRoomConfig_Builder_SetExclusiveBitMask);
	REGISTER_USER_FUNC(RealTimeRoomConfig_Builder_SetMaximumAutomatchingPlayers);
	REGISTER_USER_FUNC(RealTimeRoomConfig_Builder_Create);
	REGISTER_USER_FUNC(RealTimeRoomConfig_Builder_SetMinimumAutomatchingPlayers);
	REGISTER_USER_FUNC(RealTimeRoomConfig_Builder_Dispose);
	REGISTER_USER_FUNC(Score_Value);
	REGISTER_USER_FUNC(Score_Valid);
	REGISTER_USER_FUNC(Score_Rank);
	REGISTER_USER_FUNC(Score_Dispose);
	REGISTER_USER_FUNC(Score_Metadata);
	REGISTER_USER_FUNC(ScorePage_Dispose);
	REGISTER_USER_FUNC(ScorePage_TimeSpan);
	REGISTER_USER_FUNC(ScorePage_LeaderboardId);
	REGISTER_USER_FUNC(ScorePage_Collection);
	REGISTER_USER_FUNC(ScorePage_Start);
	REGISTER_USER_FUNC(ScorePage_Valid);
	REGISTER_USER_FUNC(ScorePage_HasPreviousScorePage);
	REGISTER_USER_FUNC(ScorePage_HasNextScorePage);
	REGISTER_USER_FUNC(ScorePage_PreviousScorePageToken);
	REGISTER_USER_FUNC(ScorePage_NextScorePageToken);
	REGISTER_USER_FUNC(ScorePage_Entries_Length);
	REGISTER_USER_FUNC(ScorePage_Entries_GetElement);
	REGISTER_USER_FUNC(ScorePage_Entry_Dispose);
	REGISTER_USER_FUNC(ScorePage_Entry_PlayerId);
	REGISTER_USER_FUNC(ScorePage_Entry_LastModified);
	REGISTER_USER_FUNC(ScorePage_Entry_Score);
	REGISTER_USER_FUNC(ScorePage_Entry_Valid);
	REGISTER_USER_FUNC(ScorePage_Entry_LastModifiedTime);
	REGISTER_USER_FUNC(ScorePage_ScorePageToken_Valid);
	REGISTER_USER_FUNC(ScorePage_ScorePageToken_Dispose);
	REGISTER_USER_FUNC(ScoreSummary_ApproximateNumberOfScores);
	REGISTER_USER_FUNC(ScoreSummary_TimeSpan);
	REGISTER_USER_FUNC(ScoreSummary_LeaderboardId);
	REGISTER_USER_FUNC(ScoreSummary_Collection);
	REGISTER_USER_FUNC(ScoreSummary_Valid);
	REGISTER_USER_FUNC(ScoreSummary_CurrentPlayerScore);
	REGISTER_USER_FUNC(ScoreSummary_Dispose);
	REGISTER_USER_FUNC(Sentinels_AutomatchingParticipant);
	REGISTER_USER_FUNC(SnapshotManager_FetchAll);
	REGISTER_USER_FUNC(SnapshotManager_ShowSelectUIOperation);
	REGISTER_USER_FUNC(SnapshotManager_Read);
	REGISTER_USER_FUNC(SnapshotManager_Commit);
	REGISTER_USER_FUNC(SnapshotManager_Open);
	REGISTER_USER_FUNC(SnapshotManager_ResolveConflict);
	REGISTER_USER_FUNC(SnapshotManager_Delete);
	REGISTER_USER_FUNC(SnapshotManager_FetchAllResponse_Dispose);
	REGISTER_USER_FUNC(SnapshotManager_FetchAllResponse_GetStatus);
	REGISTER_USER_FUNC(SnapshotManager_FetchAllResponse_GetData_Length);
	REGISTER_USER_FUNC(SnapshotManager_FetchAllResponse_GetData_GetElement);
	REGISTER_USER_FUNC(SnapshotManager_OpenResponse_Dispose);
	REGISTER_USER_FUNC(SnapshotManager_OpenResponse_GetStatus);
	REGISTER_USER_FUNC(SnapshotManager_OpenResponse_GetData);
	REGISTER_USER_FUNC(SnapshotManager_OpenResponse_GetConflictId);
	REGISTER_USER_FUNC(SnapshotManager_OpenResponse_GetConflictOriginal);
	REGISTER_USER_FUNC(SnapshotManager_OpenResponse_GetConflictUnmerged);
	REGISTER_USER_FUNC(SnapshotManager_CommitResponse_Dispose);
	REGISTER_USER_FUNC(SnapshotManager_CommitResponse_GetStatus);
	REGISTER_USER_FUNC(SnapshotManager_CommitResponse_GetData);
	REGISTER_USER_FUNC(SnapshotManager_ReadResponse_Dispose);
	REGISTER_USER_FUNC(SnapshotManager_ReadResponse_GetStatus);
	REGISTER_USER_FUNC(SnapshotManager_ReadResponse_GetData);
	REGISTER_USER_FUNC(SnapshotManager_SnapshotSelectUIResponse_Dispose);
	REGISTER_USER_FUNC(SnapshotManager_SnapshotSelectUIResponse_GetStatus);
	REGISTER_USER_FUNC(SnapshotManager_SnapshotSelectUIResponse_GetData);
	REGISTER_USER_FUNC(SnapshotMetadata_Dispose);
	REGISTER_USER_FUNC(SnapshotMetadata_CoverImageURL);
	REGISTER_USER_FUNC(SnapshotMetadata_Description);
	REGISTER_USER_FUNC(SnapshotMetadata_IsOpen);
	REGISTER_USER_FUNC(SnapshotMetadata_FileName);
	REGISTER_USER_FUNC(SnapshotMetadata_Valid);
	REGISTER_USER_FUNC(SnapshotMetadata_PlayedTime);
	REGISTER_USER_FUNC(SnapshotMetadata_LastModifiedTime);
	REGISTER_USER_FUNC(SnapshotMetadataChange_Description);
	REGISTER_USER_FUNC(SnapshotMetadataChange_Image);
	REGISTER_USER_FUNC(SnapshotMetadataChange_PlayedTimeIsChanged);
	REGISTER_USER_FUNC(SnapshotMetadataChange_Valid);
	REGISTER_USER_FUNC(SnapshotMetadataChange_PlayedTime);
	REGISTER_USER_FUNC(SnapshotMetadataChange_Dispose);
	REGISTER_USER_FUNC(SnapshotMetadataChange_ImageIsChanged);
	REGISTER_USER_FUNC(SnapshotMetadataChange_DescriptionIsChanged);
	REGISTER_USER_FUNC(SnapshotMetadataChange_Builder_SetDescription);
	REGISTER_USER_FUNC(SnapshotMetadataChange_Builder_Construct);
	REGISTER_USER_FUNC(SnapshotMetadataChange_Builder_SetPlayedTime);
	REGISTER_USER_FUNC(SnapshotMetadataChange_Builder_SetCoverImageFromPngData);
	REGISTER_USER_FUNC(SnapshotMetadataChange_Builder_Create);
	REGISTER_USER_FUNC(SnapshotMetadataChange_Builder_Dispose);
	REGISTER_USER_FUNC(TurnBasedMatch_AutomatchingSlotsAvailable);
	REGISTER_USER_FUNC(TurnBasedMatch_CreationTime);
	REGISTER_USER_FUNC(TurnBasedMatch_Participants_Length);
	REGISTER_USER_FUNC(TurnBasedMatch_Participants_GetElement);
	REGISTER_USER_FUNC(TurnBasedMatch_Version);
	REGISTER_USER_FUNC(TurnBasedMatch_ParticipantResults);
	REGISTER_USER_FUNC(TurnBasedMatch_Status);
	REGISTER_USER_FUNC(TurnBasedMatch_Description);
	REGISTER_USER_FUNC(TurnBasedMatch_PendingParticipant);
	REGISTER_USER_FUNC(TurnBasedMatch_Variant);
	REGISTER_USER_FUNC(TurnBasedMatch_HasPreviousMatchData);
	REGISTER_USER_FUNC(TurnBasedMatch_Data);
	REGISTER_USER_FUNC(TurnBasedMatch_LastUpdatingParticipant);
	REGISTER_USER_FUNC(TurnBasedMatch_HasData);
	REGISTER_USER_FUNC(TurnBasedMatch_SuggestedNextParticipant);
	REGISTER_USER_FUNC(TurnBasedMatch_PreviousMatchData);
	REGISTER_USER_FUNC(TurnBasedMatch_LastUpdateTime);
	REGISTER_USER_FUNC(TurnBasedMatch_RematchId);
	REGISTER_USER_FUNC(TurnBasedMatch_Number);
	REGISTER_USER_FUNC(TurnBasedMatch_HasRematchId);
	REGISTER_USER_FUNC(TurnBasedMatch_Valid);
	REGISTER_USER_FUNC(TurnBasedMatch_CreatingParticipant);
	REGISTER_USER_FUNC(TurnBasedMatch_Id);
	REGISTER_USER_FUNC(TurnBasedMatch_Dispose);
	REGISTER_USER_FUNC(TurnBasedMatchConfig_PlayerIdsToInvite_Length);
	REGISTER_USER_FUNC(TurnBasedMatchConfig_PlayerIdsToInvite_GetElement);
	REGISTER_USER_FUNC(TurnBasedMatchConfig_Variant);
	REGISTER_USER_FUNC(TurnBasedMatchConfig_ExclusiveBitMask);
	REGISTER_USER_FUNC(TurnBasedMatchConfig_Valid);
	REGISTER_USER_FUNC(TurnBasedMatchConfig_MaximumAutomatchingPlayers);
	REGISTER_USER_FUNC(TurnBasedMatchConfig_MinimumAutomatchingPlayers);
	REGISTER_USER_FUNC(TurnBasedMatchConfig_Dispose);
	REGISTER_USER_FUNC(TurnBasedMatchConfig_Builder_PopulateFromPlayerSelectUIResponse);
	REGISTER_USER_FUNC(TurnBasedMatchConfig_Builder_SetVariant);
	REGISTER_USER_FUNC(TurnBasedMatchConfig_Builder_AddPlayerToInvite);
	REGISTER_USER_FUNC(TurnBasedMatchConfig_Builder_Construct);
	REGISTER_USER_FUNC(TurnBasedMatchConfig_Builder_SetExclusiveBitMask);
	REGISTER_USER_FUNC(TurnBasedMatchConfig_Builder_SetMaximumAutomatchingPlayers);
	REGISTER_USER_FUNC(TurnBasedMatchConfig_Builder_Create);
	REGISTER_USER_FUNC(TurnBasedMatchConfig_Builder_SetMinimumAutomatchingPlayers);
	REGISTER_USER_FUNC(TurnBasedMatchConfig_Builder_Dispose);
	REGISTER_USER_FUNC(TurnBasedMultiplayerManager_ShowPlayerSelectUI);
	REGISTER_USER_FUNC(TurnBasedMultiplayerManager_CancelMatch);
	REGISTER_USER_FUNC(TurnBasedMultiplayerManager_DismissMatch);
	REGISTER_USER_FUNC(TurnBasedMultiplayerManager_ShowMatchInboxUI);
	REGISTER_USER_FUNC(TurnBasedMultiplayerManager_SynchronizeData);
	REGISTER_USER_FUNC(TurnBasedMultiplayerManager_Rematch);
	REGISTER_USER_FUNC(TurnBasedMultiplayerManager_DismissInvitation);
	REGISTER_USER_FUNC(TurnBasedMultiplayerManager_FetchMatch);
	REGISTER_USER_FUNC(TurnBasedMultiplayerManager_DeclineInvitation);
	REGISTER_USER_FUNC(TurnBasedMultiplayerManager_FinishMatchDuringMyTurn);
	REGISTER_USER_FUNC(TurnBasedMultiplayerManager_FetchMatches);
	REGISTER_USER_FUNC(TurnBasedMultiplayerManager_CreateTurnBasedMatch);
	REGISTER_USER_FUNC(TurnBasedMultiplayerManager_AcceptInvitation);
	REGISTER_USER_FUNC(TurnBasedMultiplayerManager_TakeMyTurn);
	REGISTER_USER_FUNC(TurnBasedMultiplayerManager_ConfirmPendingCompletion);
	REGISTER_USER_FUNC(TurnBasedMultiplayerManager_LeaveMatchDuringMyTurn);
	REGISTER_USER_FUNC(TurnBasedMultiplayerManager_LeaveMatchDuringTheirTurn);
	REGISTER_USER_FUNC(TurnBasedMultiplayerManager_TurnBasedMatchResponse_Dispose);
	REGISTER_USER_FUNC(TurnBasedMultiplayerManager_TurnBasedMatchResponse_GetStatus);
	REGISTER_USER_FUNC(TurnBasedMultiplayerManager_TurnBasedMatchResponse_GetMatch);
	REGISTER_USER_FUNC(TurnBasedMultiplayerManager_TurnBasedMatchesResponse_Dispose);
	REGISTER_USER_FUNC(TurnBasedMultiplayerManager_TurnBasedMatchesResponse_GetStatus);
	REGISTER_USER_FUNC(TurnBasedMultiplayerManager_TurnBasedMatchesResponse_GetInvitations_Length);
	REGISTER_USER_FUNC(TurnBasedMultiplayerManager_TurnBasedMatchesResponse_GetInvitations_GetElement);
	REGISTER_USER_FUNC(TurnBasedMultiplayerManager_TurnBasedMatchesResponse_GetMyTurnMatches_Length);
	REGISTER_USER_FUNC(TurnBasedMultiplayerManager_TurnBasedMatchesResponse_GetMyTurnMatches_GetElement);
	REGISTER_USER_FUNC(TurnBasedMultiplayerManager_TurnBasedMatchesResponse_GetTheirTurnMatches_Length);
	REGISTER_USER_FUNC(TurnBasedMultiplayerManager_TurnBasedMatchesResponse_GetTheirTurnMatches_GetElement);
	REGISTER_USER_FUNC(TurnBasedMultiplayerManager_TurnBasedMatchesResponse_GetCompletedMatches_Length);
	REGISTER_USER_FUNC(TurnBasedMultiplayerManager_TurnBasedMatchesResponse_GetCompletedMatches_GetElement);
	REGISTER_USER_FUNC(TurnBasedMultiplayerManager_MatchInboxUIResponse_Dispose);
	REGISTER_USER_FUNC(TurnBasedMultiplayerManager_MatchInboxUIResponse_GetStatus);
	REGISTER_USER_FUNC(TurnBasedMultiplayerManager_MatchInboxUIResponse_GetMatch);
	REGISTER_USER_FUNC(TurnBasedMultiplayerManager_PlayerSelectUIResponse_Dispose);
	REGISTER_USER_FUNC(TurnBasedMultiplayerManager_PlayerSelectUIResponse_GetStatus);
	REGISTER_USER_FUNC(TurnBasedMultiplayerManager_PlayerSelectUIResponse_GetPlayerIds_Length);
	REGISTER_USER_FUNC(TurnBasedMultiplayerManager_PlayerSelectUIResponse_GetPlayerIds_GetElement);
	REGISTER_USER_FUNC(TurnBasedMultiplayerManager_PlayerSelectUIResponse_GetMinimumAutomatchingPlayers);
	REGISTER_USER_FUNC(TurnBasedMultiplayerManager_PlayerSelectUIResponse_GetMaximumAutomatchingPlayers);
}
...
void RegisterAllStrippedInternalCalls ()
{
	...
	void Register_UnityEngine_PlatformEffector2D_get_oneWay ();
	Register_UnityEngine_PlatformEffector2D_get_oneWay ();
	void Register_UnityEngine_PlatformEffector2D_set_oneWay ();
	Register_UnityEngine_PlatformEffector2D_set_oneWay ();
	void Register_UnityEngine_PlatformEffector2D_get_sideFriction ();
	Register_UnityEngine_PlatformEffector2D_get_sideFriction ();
	void Register_UnityEngine_PlatformEffector2D_set_sideFriction ();
	Register_UnityEngine_PlatformEffector2D_set_sideFriction ();
	void Register_UnityEngine_PlatformEffector2D_get_sideBounce ();
	Register_UnityEngine_PlatformEffector2D_get_sideBounce ();
	void Register_UnityEngine_PlatformEffector2D_set_sideBounce ();
	Register_UnityEngine_PlatformEffector2D_set_sideBounce ();
	...
	void Register_UnityEngine_Terrain_get_useDefaultSmoothness ();
	Register_UnityEngine_Terrain_get_useDefaultSmoothness ();
	void Register_UnityEngine_Terrain_set_useDefaultSmoothness ();
	Register_UnityEngine_Terrain_set_useDefaultSmoothness ();
	void Register_UnityEngine_Terrain_get_defaultSmoothness ();
	Register_UnityEngine_Terrain_get_defaultSmoothness ();
	void Register_UnityEngine_Terrain_set_defaultSmoothness ();
	Register_UnityEngine_Terrain_set_defaultSmoothness ();
