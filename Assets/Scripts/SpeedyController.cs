...
public void takeMove ()
{
	...
	case "Forward Dash":
		gameObject.transform.Translate (Vector3.right * forwardDash/thisMove.initialFrames);
		break;
	...
	case "Back Dash":
		...
		gameObject.transform.Translate (-Vector3.right * backDash/thisMove.initialFrames);
		break;
